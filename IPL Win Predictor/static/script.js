...
function predictMatchScore() {
    ...
    const currentRuns = document.getElementById('current-runs').value;
    const currentOver = document.getElementById('current-over').value;
    const wicketsFallen = document.getElementById('wickets-fallen').value;
    const runsLast5 = document.getElementById('runs-last-5').value;
    const wicketsLast5 = document.getElementById('wickets-last-5').value;
